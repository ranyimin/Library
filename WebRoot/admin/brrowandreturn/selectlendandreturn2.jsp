...
<body>
	<div align="center">
		<%
			...
			String sql = "select id,lt.bookid,isbn ,bookname,lt.state,lendtime,returntime  from lendreturn as lt,book as b where lt.bookid=b.bookid ";
